        ...
        return (
          <div key={i}>
            ...
            >
              ...
              <span className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#D8DDE4] text-[#385577] transition-transform ${isOpen ? "rotate-45 bg-[#F26B38] text-white border-[#F26B38]" : ""}`}>
